...
const RH_3 = document.getElementById('RH_3');
...
const RH_3_box = document.getElementById('RH_3_box');
...
const TP_6_box = document.getElementById('TP_6_box');
...
RH_3_box.addEventListener('click', function(){
		if (RH_3.style.visibility === 'visible') {
			RH_3.style.visibility = 'hidden';} 
		else {
			RH_3.style.visibility = 'visible';
			RH_1.style.visibility = 'hidden';
			RH_2.style.visibility = 'hidden';
		}
},false);
...
TP_6_box.addEventListener('click', function(){
