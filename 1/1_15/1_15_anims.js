...
const RH_1_4_box = document.getElementById('RH_1_4_box');
const RH_1_5_box = document.getElementById('RH_1_5_box');
const RH_1_6_box = document.getElementById('RH_1_6_box');
const RH_1_7_box = document.getElementById('RH_1_7_box');
const RH_1_8_box = document.getElementById('RH_1_8_box');
const RH_2_box = document.getElementById('RH_2_box');

const LH_1_1_box = document.getElementById('LH_1_1_box');
const LH_1_2_box = document.getElementById('LH_1_2_box');
const LH_1_3_box = document.getElementById('LH_1_3_box');
const LH_1_4_box = document.getElementById('LH_1_4_box');
const LH_1_5_box = document.getElementById('LH_1_5_box');
const LH_1_6_box = document.getElementById('LH_1_6_box');
const LH_1_7_box = document.getElementById('LH_1_7_box');
const LH_1_8_box = document.getElementById('LH_1_8_box');
const LH_2_box = document.getElementById('LH_2_box');

const TP_1_1_box = document.getElementById('TP_1_1_box');
const TP_1_2_box = document.getElementById('TP_1_2_box');
const TP_1_3_box = document.getElementById('TP_1_3_box');
const TP_1_4_box = document.getElementById('TP_1_4_box');
const TP_1_5_box = document.getElementById('TP_1_5_box');
const TP_1_6_box = document.getElementById('TP_1_6_box');
const TP_1_7_box = document.getElementById('TP_1_7_box');
const TP_1_8_box = document.getElementById('TP_1_8_box');
...
RH_1_4_box.addEventListener('click', function(){
		if (RH_1.style.visibility === 'visible') {
			RH_1.style.visibility = 'hidden';} 
		else {
			RH_1.style.visibility = 'visible';
...
RH_1_5_box.addEventListener('click', function(){
		if (RH_1.style.visibility === 'visible') {
			RH_1.style.visibility = 'hidden';} 
		else {
			RH_1.style.visibility = 'visible';
...
RH_1_6_box.addEventListener('click', function(){
		if (RH_1.style.visibility === 'visible') {
			RH_1.style.visibility = 'hidden';} 
		else {
			RH_1.style.visibility = 'visible';
...
RH_1_7_box.addEventListener('click', function(){
		if (RH_1.style.visibility === 'visible') {
			RH_1.style.visibility = 'hidden';} 
		else {
			RH_1.style.visibility = 'visible';
...
RH_1_8_box.addEventListener('click', function(){
		if (RH_1.style.visibility === 'visible') {
			RH_1.style.visibility = 'hidden';} 
		else {
			RH_1.style.visibility = 'visible';
...
LH_1_1_box.addEventListener('click', function(){
...
LH_1_2_box.addEventListener('click', function(){
		if (LH_1.style.visibility === 'visible') {
			LH_1.style.visibility = 'hidden';} 
		else {
			LH_1.style.visibility = 'visible';
...
LH_1_3_box.addEventListener('click', function(){
		if (LH_1.style.visibility === 'visible') {
			LH_1.style.visibility = 'hidden';} 
		else {
			LH_1.style.visibility = 'visible';
...
LH_1_4_box.addEventListener('click', function(){
		if (LH_1.style.visibility === 'visible') {
			LH_1.style.visibility = 'hidden';} 
		else {
			LH_1.style.visibility = 'visible';
...
LH_1_5_box.addEventListener('click', function(){
		if (LH_1.style.visibility === 'visible') {
			LH_1.style.visibility = 'hidden';} 
		else {
			LH_1.style.visibility = 'visible';
...
LH_1_6_box.addEventListener('click', function(){
		if (LH_1.style.visibility === 'visible') {
			LH_1.style.visibility = 'hidden';} 
		else {
			LH_1.style.visibility = 'visible';
...
LH_1_7_box.addEventListener('click', function(){
		if (LH_1.style.visibility === 'visible') {
			LH_1.style.visibility = 'hidden';} 
		else {
			LH_1.style.visibility = 'visible';
...
LH_1_8_box.addEventListener('click', function(){
		if (LH_1.style.visibility === 'visible') {
			LH_1.style.visibility = 'hidden';} 
		else {
			LH_1.style.visibility = 'visible';
...
TP_1_1_box.addEventListener('click', function(){
...
TP_1_2_box.addEventListener('click', function(){
		if (TP_1.style.visibility === 'visible') {
			TP_1.style.visibility = 'hidden';} 
		else {
			TP_1.style.visibility = 'visible';
...
TP_1_3_box.addEventListener('click', function(){
		if (TP_1.style.visibility === 'visible') {
			TP_1.style.visibility = 'hidden';} 
		else {
			TP_1.style.visibility = 'visible';
...
TP_1_4_box.addEventListener('click', function(){
		if (TP_1.style.visibility === 'visible') {
			TP_1.style.visibility = 'hidden';} 
		else {
			TP_1.style.visibility = 'visible';
...
TP_1_5_box.addEventListener('click', function(){
		if (TP_1.style.visibility === 'visible') {
			TP_1.style.visibility = 'hidden';} 
		else {
			TP_1.style.visibility = 'visible';
...
TP_1_6_box.addEventListener('click', function(){
		if (TP_1.style.visibility === 'visible') {
			TP_1.style.visibility = 'hidden';} 
		else {
			TP_1.style.visibility = 'visible';
...
TP_1_7_box.addEventListener('click', function(){
		if (TP_1.style.visibility === 'visible') {
			TP_1.style.visibility = 'hidden';} 
		else {
			TP_1.style.visibility = 'visible';
...
TP_1_8_box.addEventListener('click', function(){
		if (TP_1.style.visibility === 'visible') {
			TP_1.style.visibility = 'hidden';} 
		else {
			TP_1.style.visibility = 'visible';
